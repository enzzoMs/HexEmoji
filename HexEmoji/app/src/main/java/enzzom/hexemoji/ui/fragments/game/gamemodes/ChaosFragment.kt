...
import enzzom.hexemoji.databinding.FragmentChaosBinding
import enzzom.hexemoji.models.GameStatus
import enzzom.hexemoji.ui.fragments.game.BaseGameModeFragment
import enzzom.hexemoji.ui.fragments.game.gamemodes.model.ChaosViewModel
...
class ChaosFragment : BaseGameModeFragment() {
    ...
    override fun initializeViews(inflater: LayoutInflater, container: ViewGroup?): GameViews {
        ...
        binding.apply {
            ...
            chaosCountdown.addOnCountdownFinished { gameViewModel.countdownManager.startTimer() }
