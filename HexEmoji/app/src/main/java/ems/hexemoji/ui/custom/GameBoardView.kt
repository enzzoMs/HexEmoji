...
import ems.hexemoji.databinding.ViewGameBoardBinding
...
class GameBoardView(context: Context, attrs: AttributeSet? = null) : FrameLayout(context, attrs) {
    ...
    private val movementGestureDetector: GestureDetector
    ...
    init {
        ...
        movementGestureDetector = GestureDetector(context, object : GestureDetector.SimpleOnGestureListener() {
