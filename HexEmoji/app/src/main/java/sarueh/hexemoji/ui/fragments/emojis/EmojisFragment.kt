package sarueh.hexemoji.ui.fragments.emojis
...
import sarueh.hexemoji.databinding.DialogChallengeCompletedBinding
import sarueh.hexemoji.databinding.DialogRefreshChallengesBinding
import sarueh.hexemoji.databinding.FragmentEmojisBinding
import sarueh.hexemoji.models.EmojiCategoryDetails
import sarueh.hexemoji.ui.fragments.emojis.adapters.ChallengesAdapter
import sarueh.hexemoji.ui.fragments.emojis.adapters.CollectionDetailsAdapter
import sarueh.hexemoji.ui.fragments.emojis.model.EmojisViewModel
        ...
        binding.apply {
            ...
            for (position in 0 until collectionDetailsList.adapter!!.itemCount) {
                collectionTabs.newTab().let { tab ->
                    ...
                    tab.setContentDescription(categoryTitles[position])
                }
            }
