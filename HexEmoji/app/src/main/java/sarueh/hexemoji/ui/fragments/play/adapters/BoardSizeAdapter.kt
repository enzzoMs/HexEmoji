...
import sarueh.hexemoji.databinding.ItemCardBoardSizeBinding
import sarueh.hexemoji.models.BoardSize
import sarueh.hexemoji.utils.recyclerview.HexagonalLayout
...
class BoardSizeAdapter(
    ...
    private val hexagonMarginPx: Int = 0,
